...
<!--{{ config('app.name', 'Biblioteca') }}-->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    <ul class="navbar-nav me-auto href="{{ url('/') }}">
<!--<li>
                            <a class="nav-link" href="{{ route('biblioteca.index')}}">{{ __('Biblioteca')}}</a>
                        </li>-->
                        <li>
                        ...
                        <li>
                            <a class="nav-link" href="{{ route('nacionalidades.index')}}">{{ __('Nacionalidades')}}</a>
                        </li>
                        <li>
